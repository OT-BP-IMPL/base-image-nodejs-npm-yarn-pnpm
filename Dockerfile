...
RUN set -eux; \
    for version in 14.21.3 16.20.0 18.17.1 20.5.0 20.13.0 21.7.3 22.8.0 24.7.0 25.1.0; do \
...
RUN for version in 14.21.3 16.20.0 18.17.1 20.5.0 20.13.0 21.7.3 22.8.0 24.7.0 25.1.0; do \
